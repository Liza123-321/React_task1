        ...
        return (
            <form onSubmit={handleSubmit}>
                <Card className={props.classes.card}>
                    ...
                    <div>
                        <Field name="email" component={this.renderField} label="email" onChange={ props.handleUserInput} values={props.email} type="email" />
                    </div>
                    <div>
                        <Field name="password" component={this.renderField} label="password" onChange={ props.handleUserInput} values={props.password} type="password"/>
                    </div>
